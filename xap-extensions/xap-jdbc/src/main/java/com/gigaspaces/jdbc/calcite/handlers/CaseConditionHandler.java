...
public class CaseConditionHandler extends RexShuttle {
            ...
            if (operand.isA(SqlKind.LOCAL_REF)) {
                ...
                switch (rexNode.getKind()) {
                    case INPUT_REF:
                        ...
                        IQueryColumn queryColumn = tableForColumn.addQueryColumnWithColumnOrdinal(fieldName, null, false, -1);
    ...
    private SingleCaseCondition handleTwoOperandsCall(RexNode leftOp, RexNode rightOp, SqlKind sqlKind, boolean isNot){
        ...
        IQueryColumn queryColumn = tableForColumn.addQueryColumnWithColumnOrdinal(column, null, false, -1);
        queryExecutor.addColumn(queryColumn);
